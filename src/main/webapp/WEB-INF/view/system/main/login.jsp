...
<form class="layui-form" id="loginFrm" method="post" action="${ctx }/login/login.action">
    ...
    <div class="layui-form-item input-item">
        ...
        <input type="text" placeholder="请输入用户名" id="userName" autocomplete="off" name="loginname" class="layui-input"
               lay-verify="required">
    </div>
    <div class="layui-form-item input-item">
        <label for="password">密码</label>
        <input type="password" placeholder="请输入密码" id="password" autocomplete="off" name="pwd" class="layui-input"
               lay-verify="required">
    </div>
    <div class="layui-form-item input-item" id="imgCode">
        <label for="code">验证码</label>
        <input type="text" placeholder="请输入验证码" autocomplete="off" id="code" name="code" class="layui-input">
        <img src="${ctx}/login/getCode.action" onclick="this.src='${ctx}/login/getCode.action?'+new Date()">
    </div>
