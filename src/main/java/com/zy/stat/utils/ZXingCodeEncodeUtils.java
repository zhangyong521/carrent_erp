...
//		createZXingCodeSaveToDisk("张三", 400, 400, "D:/laolei.gif", "JPEG");
		InputStream logoStream=ZXingCodeEncodeUtils.class.getClassLoader().getResourceAsStream("logo.jpg");
		createZxingCodeUseLogoSaveToDisk("张三", 400, 400, "D:/laolei.gif", "JPEG", logoStream);
